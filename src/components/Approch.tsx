...
export const Approch = () => {
  return (
    <section className='w-full py-20'>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-centerw-full gap-4  ">
        <Card
         title="Planning & Strategy" 
         icon={<AceternityIcon order={"phase 1"}/>} des ="We'll collaborate to map out your website's goals, target audience, 
